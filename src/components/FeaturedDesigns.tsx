...
const featuredDesigns: BraceletDesign[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        bead: { id: "a1-x", name: "金色隔珠", color: "金色", category: "紫水晶", shape: "round", size: 6, meaning: "", colorHex: "#c9a04e" },
      },
      {
    ...
    <section className="py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12">
          <Link
            to="/gallery"
            className="inline-flex items-center gap-2 px-6 py-3 border border-[#c9a04e]/20 rounded-full text-[#c9a04e]/70 hover:text-[#c9a04e] hover:bg-[#c9a04e]/[0.06] hover:border-[#c9a04e]/40 transition-all duration-300 text-sm tracking-wide"
          >
            查看全部作品
